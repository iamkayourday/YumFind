...
import { usernameValidation, passwordValidation, emailValidation } from '../Utils/ValidationSchema';
        ...
        {({ errors, touched }) => (
          <div className="p-8 rounded-lg max-w-md w-full bg-[#21412F] shadow-sm">
            ...
            <div className="text-center">
              <p className='text-[#7C7979]'>Already a member? <Link to='/' className="text-white underline">Login</Link></p>
            </div>
          </div>
        )}
      </Formik>
